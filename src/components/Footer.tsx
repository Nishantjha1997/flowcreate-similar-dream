...
const Footer = () => {
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
            ...
            {[
              ...
              { title: 'Company', links: [{ to: '/about', label: 'About' }, { to: '/login', label: 'Log In' }, { to: '/privacy', label: 'Privacy' }, { to: '/terms', label: 'Terms' }, { to: '/refund-policy', label: 'Refund Policy' }, { to: '/shipping-policy', label: 'Shipping Policy' }] },
            ].map((section) => (
  ...
  const footerSections = [
    ...
    { title: 'Resources', links: [{ to: '/blog', label: 'Blog' }, { to: '/resources', label: 'Resources' }, { to: '/help', label: 'Help Center' }, { to: '/career-advice', label: 'Career Advice' }] },
    { title: 'Company', links: [{ to: '/about', label: 'About' }, { to: '/login', label: 'Log In' }, { to: '/privacy', label: 'Privacy Policy' }, { to: '/terms', label: 'Terms of Use' }, { to: '/refund-policy', label: 'Refund Policy' }, { to: '/shipping-policy', label: 'Shipping Policy' }] }
  ];
