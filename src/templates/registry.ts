...
export const TEMPLATE_REGISTRY: TemplateDefinition[] = [
...

  {
    key: 'atlantic-blue',
    legacyIds: [],
    name: 'Northstar Panel',
    category: 'Professional',
    description: 'Deep navy profile rail with crisp metadata and a bright, spacious career column.',
    layout: 'sidebar-left',
    atsOptimized: false,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Tide Minimal',
    category: 'Minimal',
    description: 'Centered introduction with sea-green accents and a calm chronological rhythm.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: false,
  ...
  },
  {
    ...
    name: 'Scholar Frame',
    category: 'Professional',
    description: 'Editorial serif typography with a restrained portrait and academic clarity.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: false,
  ...
  },
  {
    ...
    name: 'Meridian Rule',
    category: 'Professional',
    description: 'Confident nameplate and structured blue rules for corporate applications.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Ledger Serif',
    category: 'Minimal',
    description: 'Dense executive hierarchy with serif type and disciplined horizontal separators.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: false,
  ...
  },
  {
    key: 'hunter-green',
    legacyIds: [],
    name: 'Evergreen Column',
    category: 'Creative',
    description: 'Forest profile column paired with a light, highly readable experience canvas.',
    layout: 'sidebar-left',
    atsOptimized: false,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Horizon Banner',
    category: 'Professional',
    description: 'Wide cobalt introduction band above a balanced modular content grid.',
    layout: 'header-band',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Signal Line',
    category: 'Creative',
    description: 'Minimal white canvas anchored by an energetic electric-blue edge.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Matrix Compact',
    category: 'ATS-Friendly',
    description: 'High-density ATS layout with measurable skills and compact professional detail.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Amber Thread',
    category: 'Minimal',
    description: 'Fine warm rules and generous white space create a polished, approachable page.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Graphite Band',
    category: 'Professional',
    description: 'Graphite introduction band with high-contrast identity and clean body sections.',
    layout: 'header-band',
    atsOptimized: true,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Silver Rail',
    category: 'Minimal',
    description: 'Soft silver information rail with modern typography and understated contrast.',
    layout: 'sidebar-left',
    atsOptimized: false,
    featured: true,
    premium: false,
  ...
  },
  {
    ...
    name: 'Night Canvas',
    category: 'Creative',
    description: 'Dramatic dark canvas with luminous details for creative and technology roles.',
    layout: 'single',
    atsOptimized: false,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Studio Serif',
    category: 'Creative',
    description: 'Portrait-led studio rail paired with characterful serif editorial typography.',
    layout: 'sidebar-left',
    atsOptimized: false,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Harbor Serif',
    category: 'Professional',
    description: 'Editorial serif hierarchy with calm teal rules and generous reading space.',
    layout: 'single',
    atsOptimized: true,
    featured: true,
    premium: false,
    supportsPhoto: false,
    defaultAccent: '#164e63',
  },
  {
    key: 'column-ledger',
    legacyIds: [],
    name: 'Column Ledger',
    category: 'Executive',
    description: 'Warm right-hand details rail with a dense, disciplined leadership column.',
    layout: 'sidebar-right',
    atsOptimized: false,
    featured: true,
    premium: true,
  ...
  },
  {
    ...
    name: 'Graduate Focus',
    category: 'ATS-Friendly',
    description: 'Clear blue introduction band built for internships and early-career applications.',
    layout: 'header-band',
    atsOptimized: true,
    featured: true,
    premium: false,
  ...
  },
  {
    ...
    name: 'Studio Grid',
    category: 'Creative',
    description: 'Monochrome portfolio grid with a compact studio rail and warm orange detail.',
    layout: 'sidebar-left',
    atsOptimized: false,
    featured: true,
    premium: true,
