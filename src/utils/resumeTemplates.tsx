...
const templateStyles: Record<string, TemplateStyles> = {
  ...
  apple: {
    personal: {
      ...
      summary: 'Design-driven product engineer with 8 years building intuitive, pixel-perfect user interfaces for consumer hardware and software at scale.',
      website: 'liamchen.design',
      linkedin: 'linkedin.com/in/liamchen',
      profileImage: '',
    },
    experience: [
      { id: 1, title: 'Senior Product Designer', company: 'Cupertino Tech', location: 'Cupertino, CA', startDate: 'Mar 2021', endDate: '', current: true, description: 'Designed system-level interactions for flagship devices. Led a team of 6 designers across hardware and software verticals.' },
      { id: 2, title: 'UX Engineer', company: 'Infinite Loop Labs', location: 'San Jose, CA', startDate: 'Jan 2018', endDate: 'Feb 2021', current: false, description: 'Built design systems used by 200+ engineers. Reduced design-to-code handoff time by 60%.' },
    ],
    education: [{ id: 1, school: 'Stanford University', degree: 'M.S.', field: 'Human-Computer Interaction', startDate: '2016', endDate: '2018', description: '' }],
    skills: ['Design Systems', 'SwiftUI', 'Figma', 'Prototyping', 'User Research', 'Accessibility'],
    projects: [{ id: 1, title: 'Adaptive UI Framework', description: 'Created a responsive component library adopted across 12 product teams.', technologies: ['SwiftUI', 'Figma'], link: '' }],
    customization: { primaryColor: '#1d1d1f', fontSize: 'medium', spacing: 'spacious' },
  },

  'apple-dark': {
    personal: {
      name: 'Aria Nakamura',
      email: 'aria.n@email.com',
      phone: '(555) 456-7891',
      address: 'San Francisco, CA',
      summary: 'Full-stack engineer specializing in native app development with a focus on performance, accessibility, and beautiful user experiences.',
      website: 'arianakamura.dev',
      linkedin: 'linkedin.com/in/arianakamura',
      profileImage: '',
    },
    experience: [
      { id: 1, title: 'Staff Engineer', company: 'DarkMode Studios', location: 'SF, CA', startDate: 'Jun 2020', endDate: '', current: true, description: 'Architected cross-platform rendering engine used by 15M+ users. Led dark-mode accessibility initiative.' },
    ],
    education: [{ id: 1, school: 'UC Berkeley', degree: 'B.S.', field: 'Computer Science', startDate: '2014', endDate: '2018', description: '' }],
    skills: ['Swift', 'Kotlin', 'React Native', 'Metal', 'Core Animation', 'Accessibility'],
    projects: [],
    customization: { primaryColor: '#f5f5f7', fontSize: 'medium', spacing: 'normal' },
  },
  ...
  facebook: {
    personal: {
      ...
      summary: 'Growth engineer with 6+ years building viral features, A/B testing frameworks, and recommendation systems at social media scale.',
      website: '',
      linkedin: 'linkedin.com/in/davidokafor',
      profileImage: '',
    },
    experience: [
      { id: 1, title: 'Senior Growth Engineer', company: 'Social Platform Inc', location: 'Menlo Park, CA', startDate: 'Jan 2021', endDate: '', current: true, description: 'Built recommendation algorithms increasing daily active users by 12%. Designed A/B testing infrastructure handling 500M+ experiments.' },
      { id: 2, title: 'Software Engineer', company: 'ConnectApp', location: 'Palo Alto, CA', startDate: 'Aug 2018', endDate: 'Dec 2020', current: false, description: 'Developed real-time messaging features serving 100M+ concurrent users.' },
    ],
    education: [{ id: 1, school: 'Carnegie Mellon', degree: 'B.S.', field: 'Computer Science', startDate: '2014', endDate: '2018', description: '' }],
    skills: ['Python', 'React', 'GraphQL', 'Machine Learning', 'A/B Testing', 'Data Pipelines', 'Hack'],
    projects: [],
    customization: { primaryColor: '#1877f2', fontSize: 'medium', spacing: 'normal' },
  },
  ...
  meta: {
    personal: {
      ...
      phone: '(555) 345-6780',
      address: 'Seattle, WA',
      summary: 'AR/VR engineer passionate about building the next generation of immersive computing experiences. Expert in 3D rendering, spatial computing, and cross-platform frameworks.',
      website: 'sofiamartinez.xyz',
      linkedin: 'linkedin.com/in/sofiamartinez',
      profileImage: '',
    },
    experience: [
      { id: 1, title: 'XR Platform Engineer', company: 'Reality Labs Corp', location: 'Seattle, WA', startDate: 'Apr 2021', endDate: '', current: true, description: 'Built spatial computing frameworks for mixed reality headsets. Reduced render latency by 35% across all supported devices.' },
    ],
    education: [{ id: 1, school: 'MIT', degree: 'M.S.', field: 'Computer Graphics', startDate: '2017', endDate: '2019', description: '' }],
    skills: ['C++', 'OpenXR', 'Unity', 'Vulkan', 'Spatial Audio', 'Computer Vision', 'Python'],
    projects: [{ id: 1, title: 'Hand Tracking SDK', description: 'Open-source hand tracking library for WebXR with sub-10ms latency.', technologies: ['C++', 'WebXR'], link: '' }],
    customization: { primaryColor: '#0668E1', fontSize: 'medium', spacing: 'normal' },
  },
};
