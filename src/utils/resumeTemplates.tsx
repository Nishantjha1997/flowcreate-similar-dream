...
const templateStyles: Record<string, TemplateStyles> = {
  ...
  'typewriter-photo': {
    ...
    sidebar: {
      width: '35%',
      backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.65)), url(https://images.unsplash.com/photo-1497366216548-37526070297c?w=500&auto=format&fit=crop&q=80)',
